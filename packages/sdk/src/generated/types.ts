...
export interface paths {
    ...
    "/admin/content/{id}/validate": {
        ...
        get?: never;
        put?: never;
        post: operations["adminValidateContent"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admin/content/generate": {
        ...
        get?: never;
        put?: never;
        post: operations["adminGenerateContent"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admin/skills": {
        ...
        get: operations["adminListSkills"];
        put?: never;
        post: operations["adminCreateSkill"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ContentItemAdmin: {
            ...
            slug: string;
            /** @enum {string} */
            type: "coding_challenge" | "project_step" | "interview_problem" | "knowledge_question";
            language: string;
            /** @enum {string} */
            status: "DRAFT" | "VALIDATED" | "REVIEW" | "PUBLISHED" | "ARCHIVED";
        ...
        CategoryAdmin: {
            ...
            /** @enum {string} */
            kind: "pillar" | "track" | "section" | "topic" | "collection";
            sortOrder: number;
        };
        TagAdmin: {
            id: string;
...
export interface operations {
    adminListContent: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data: components["schemas"]["ContentItemAdmin"][];
                    };
                };
            };
        };
    ...
    adminGetContent: {
        ...
        requestBody?: never;
        responses: {
            /** @description Get content item detail */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    adminPublishContent: {
        ...
        requestBody?: never;
        responses: {
            /** @description Published content revision */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    adminListCategories: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data: components["schemas"]["CategoryAdmin"][];
                    };
                };
            };
        };
    ...
    adminListTags: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data: components["schemas"]["TagAdmin"][];
                    };
                };
            };
        };
    ...
    adminListSkills: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data: components["schemas"]["SkillAdmin"][];
                    };
                };
            };
        };
