...
export function ChallengeWorkspace({ challenge, trackId, sectionId, sectionTitle, position, continueTo }: {
  ...
  const returnTo = `/learn/${trackId}/${sectionId}`
  ...
  return (
    <div className="workspace-page">
      <header className="workspace-header">
        ...
        <div className="workspace-meta"><span>{position}</span><span className="level-chip">Guided</span><span>{challenge.reward.xp} XP</span></div>
      </header>
